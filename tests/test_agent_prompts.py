...
class AgentPromptTests(unittest.TestCase):
    def test_prompt_files_and_wiring(self):
        ...
        self.assertIn("After planning configuration loads successfully", plan_prompt)
        self.assertIn("return only a `Readiness` section", plan_prompt)
        self.assertIn("corresponding\ncapability skill", plan_prompt)
        self.assertIn("configured\nplanning-status label", plan_prompt)
